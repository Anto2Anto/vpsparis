...
class ServicesAdmin(admin.ModelAdmin):  # TranslationAdmin
...
class CleEnMainAdmin(admin.ModelAdmin):  # TranslationAdmin
...
class ServiceCatAdmin(admin.ModelAdmin):  # TranslationAdmin
...
class CleEnMainCatAdmin(admin.ModelAdmin):  # TranslationAdmin
        list_display = ('id', 'name', 'content', 'is_published')
        list_display_links = ('id', 'name')
        search_fields = ('name',)
        # list_filter = ('id', 'name')
